...
ARG PACK_LIST="bash-completion git curl wget sudo unzip tini iproute net-tools glibc-langpack-en pinentry nail postfix \
  "
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdev/almalinux" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdev/almalinux" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdev/almalinux" \
  org.opencontainers.image.documentation="https://github.com/casjaysdev/almalinux" \
