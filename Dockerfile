# Docker image for almalinux using the almalinux template
ARG IMAGE_NAME="almalinux"
ARG PHP_SERVER="almalinux"
ARG BUILD_DATE="Fri Sep  1 02:22:58 AM EDT 2023"
...
ARG PACK_LIST="bash bash-completion git curl wget sudo unzip tini iproute net-tools glibc-langpack-en pinentry nail postfix"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdev/docker-almalinux" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdev/docker-almalinux" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdev/docker-almalinux" \
  org.opencontainers.image.documentation="https://github.com/casjaysdev/docker-almalinux" \
